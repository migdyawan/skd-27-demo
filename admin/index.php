                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="index.php">hari ini</a>
                                    <a class="nav-link" href="index.php">arsip</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data absen hari ini <span class="float-end"><?php echo $today; ?></span></h1>
                        ...
                        <a href="../function/config/config_export_data.php" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> &nbsp Excel</a>
                        <table class="table table-hover table-bordered results">
                            ...
                            <tr>
                                ...
                                <th class="col-md-3 col-xs-3">Tanggal</th>
                            ...
                            <?php
                            $sql = "SELECT * FROM data WHERE tanggal='{$today}'   ";
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="alert-alert-absen">Sudah Absen</p>
                                </td>
                            </tr>
                            <?php } ?>
